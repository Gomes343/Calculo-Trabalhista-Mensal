...
public class Aplicação{
    ...
    public static void main(String[] args) {
        ...
        double total = salario_liquido + e.vlr_FGTS + e.vlr_IRRF + d.ferias + d.decimo + d.terco + d.FGTS_fer_decimo + d.INSS_fer_decimo + d.IRRF_fer_decimo;
